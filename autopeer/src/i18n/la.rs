pub(super) const TABLE: &[(&str, &str)] = &[
    ...
    ("stage3.review.encrypt_endpoint.enabled", "Encryptata"),
    ...
    ("stage3.review.check_session_label", "Sessio BGP"),
    ...
    ("location.region.asia_se", "Asia Meridionalis Orientalis"),
    ("location.region.asia_e", "Asia Orientalis"),
    ...
    ("location.country.be", "Belgia"),
    ("location.country.br", "Brasilia"),
    ("location.country.bg", "Bulgaria"),
    ("location.country.ca", "Canada"),
    ("location.country.cn", "Sinae"),
    ("location.country.cz", "Bohemia"),
    ("location.country.dk", "Dania"),
    ("location.country.fi", "Finnia"),
    ("location.country.fr", "Gallia"),
    ("location.country.de", "Germania"),
    ("location.country.hk", "Hongcongum"),
    ("location.country.hu", "Hungaria"),
    ("location.country.in", "India"),
    ("location.country.id", "Indonesia"),
    ("location.country.ie", "Hibernia"),
    ("location.country.it", "Italia"),
    ("location.country.jp", "Iaponia"),
    ("location.country.kr", "Corea Meridionalis"),
    ("location.country.lu", "Luxemburgum"),
    ("location.country.my", "Malesia"),
    ("location.country.nl", "Nederlandia"),
    ("location.country.nz", "Nova Zelandia"),
    ("location.country.no", "Norvegia"),
    ("location.country.pl", "Polonia"),
    ("location.country.pt", "Lusitania"),
    ("location.country.ro", "Romania"),
    ("location.country.ru", "Russia"),
    ("location.country.sg", "Singapura"),
    ("location.country.za", "Africa Meridionalis"),
    ("location.country.es", "Hispania"),
    ("location.country.se", "Suecia"),
    ("location.country.ch", "Helvetia"),
    ("location.country.tw", "Formosa"),
    ("location.country.th", "Thailandia"),
    ("location.country.tr", "Turcia"),
    ("location.country.ua", "Ucraina"),
    ("location.country.gb", "Britannia"),
    ("location.country.us", "Civitates Foederatae"),
    ("location.country.vn", "Vietnamia"),
    ...
    (
        ...
        "Inscriptio IPv6 paris necessaria est, vel muta transitum ad IPv4 in optionibus provectis",
    ),
    (
